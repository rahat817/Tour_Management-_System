...
public class InternationalMaldives extends JFrame {
    ...
    InternationalMaldives() {
        ...
        // Title
        label1 = new JLabel();
        label1.setText("3 Packs Available for Maldives Tour");
        ...
        image = new ImageIcon("./images/maldives.jpeg");
