...
public class MobileBanking extends JFrame {
    ...
    MobileBanking() {
        ...
        img1 = new ImageIcon(getClass().getResource("/images/bkash1.png"));
        imgLabel = new JLabel(img1);
        imgLabel.setBounds(620, 90, img1.getIconWidth(), img1.getIconHeight());
        c.add(imgLabel);

        img2 = new ImageIcon(getClass().getResource("/images/nagad1.png"));
        ...
        // Name On Card
        label3 = new JLabel("Enter your number");
        label3.setBounds(400, 180, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        tf1 = new JTextField();
        tf1.setBounds(600, 190, 235, 30);
        tf1.setFont(f4);
        c.add(tf1);

        // Otp
        label3 = new JLabel("OTP");
        label3.setBounds(400, 220, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        tf2 = new JTextField();
        tf2.setBounds(600, 230, 80, 30);
        tf2.setFont(f4);
        ...
        label3.setBounds(400, 260, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        pf = new JPasswordField();
        pf.setBounds(600, 270, 80, 30);
        ...
        // Confirm MobileBanking Button
        btn3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                String phone = tf1.getText();
                String OTP = tf2.getText();
                String pin = pf.getText();
                
                if (phone.isEmpty() || OTP.isEmpty() || pin.isEmpty()) {
