...
public class DomesticSreemangal extends JFrame {
    ...
    DomesticSreemangal() {
        ...
        label1.setBounds(445, 35, 600, 50);
        label1.setFont(f1);
        ...
        label2.setBounds(445, 70, 500, 50);
        label2.setFont(f1);
        ...
        pack1.setBounds(445, 120, 100, 50);
        pack1.setFont(f3);
        pack1.setBackground(Color.decode("#F2F2F2"));
        pack1.setCursor(cursor);
        pack1.setForeground(Color.BLACK);
        c.add(pack1);

        label3 = new JLabel();
        label3.setText("* First Class");
        label3.setBounds(445, 150, 520, 50);
        label3.setFont(f4);
        ...
        label3.setBounds(445, 180, 520, 50);
        label3.setFont(f4);
        label3.setForeground(Color.BLACK);
        c.add(label3);
        ...
        label3.setBounds(445, 210, 520, 50);
        label3.setFont(f4);
        label3.setForeground(Color.BLACK);
        c.add(label3);
        ...
        label3.setBounds(445, 240, 520, 50);
        label3.setFont(f4);
        label3.setForeground(Color.BLACK);
        c.add(label3);
        ...
        label3.setBounds(445, 270, 520, 50);
        label3.setFont(f4);
        label3.setForeground(Color.BLACK);
        c.add(label3);
        ...
        label3.setBounds(445, 300, 520, 50);
        label3.setFont(f4);
        label3.setForeground(Color.BLACK);
        c.add(label3);
        ...
        pack2.setForeground(Color.BLACK);
        c.add(pack2);
        ...
        pack3.setForeground(Color.BLACK);
        c.add(pack3);
        ...
        image = new ImageIcon("./images/sree.jpeg");
