...
public class India extends Thailand
{
		public void InternationalGermany()throws IOException, InterruptedException{
				 ...
				 if(hotel == 1)
		{
				 ...
				 else if(hotel == 5)
			{
			    ...
			    new ProcessBuilder("cmd", "/c", "cls").inheritIO().start().waitFor();
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*****************************************************");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*            Popular places in Germany              *");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*                                                   *");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*****************************************************\n");
				 String array[]=new String []{" The Brandenburg Gate"," The Rebuilt Reichstag"," Museum Island"," German Historical Museum"," Berlin Wall Memorial"};
