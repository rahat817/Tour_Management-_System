...
public class China extends Indonesia
{
		public void InternationalItaly()throws IOException, InterruptedException{
				 ...
				 if(hotel == 1)
		{
				 ...
				 else if(hotel == 5)
			{
				 ...
				 new ProcessBuilder("cmd", "/c", "cls").inheritIO().start().waitFor();
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*****************************************************");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*            Popular places in Italy                *");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*                                                   *");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*****************************************************\n");
				 String array[]=new String []{" Colosseum"," Cinque Terre"," Cathedral of Santa Maria del Fiore"," Trevi Fountain"," Uffizi Gallery"};
